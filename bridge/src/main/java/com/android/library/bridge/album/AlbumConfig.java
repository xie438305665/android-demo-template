...
public class AlbumConfig {
    ...
    private int albumToolbarIcon = R.drawable.album_ic_action_back_day;
    ...
    private int albumBottomFinderTextCompoundDrawable = R.drawable.album_ic_action_finder_day;
    ...
    private int albumContentViewCameraDrawable = R.drawable.album_ic_camera_alt_black_24dp;
    private int albumContentViewCameraDrawableColor = R.color.colorAlbumContentViewCameraDrawableColorDay;
    private int albumContentItemCheckBoxDrawable = R.drawable.album_selector_album_item_check;
    private int albumContentEmptyDrawable = R.drawable.album_ic_camera_alt_black_24dp;
    private int albumContentEmptyDrawableColor = R.color.colorAlbumContentEmptyDrawableColorDay;
    /////////// album preview ////////
    private int albumPreviewTitle = R.string.album_preview_title;
    ...
    private int albumPreviewBottomOkText = R.string.album_preview_select;
