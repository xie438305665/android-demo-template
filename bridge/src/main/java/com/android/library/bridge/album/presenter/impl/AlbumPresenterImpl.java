...
import com.android.library.bridge.album.presenter.AlbumPresenter;
...
import com.android.library.bridge.album.util.task.AlbumTaskCallBack;
...
public class AlbumPresenterImpl implements AlbumPresenter, ScanCallBack {
    ...
    public void scan(final String bucketId, final int page, final int count) {
        ...
        AlbumTask.get().start(() -> scanView.start(AlbumPresenterImpl.this, bucketId, page, count));
    }
