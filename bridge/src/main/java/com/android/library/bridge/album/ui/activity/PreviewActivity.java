...
import com.android.library.bridge.album.presenter.impl.PreviewPresenterImpl;
import com.android.library.bridge.album.ui.adapter.PreviewAdapter;
import com.android.library.bridge.album.ui.view.PreviewMethodActivityView;
...
public class PreviewActivity extends AlbumBaseActivity implements View.OnClickListener, PreviewView, PreviewMethodActivityView {
    ...
    public void initBundle() {
        Bundle extras = getPreviewActivity().getIntent().getExtras();
