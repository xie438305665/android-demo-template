...
import com.demo.template.mvp.presenter.impl.ProblemTaskPresenterImpl;
 ...
 * 问题卷任务
 */
public class ProblemTaskFragment extends MVPFragment<ProblemTaskPresenterImpl, List<Object>>
        implements ProblemTaskView, LoadListener, OnXBindListener<Object> {
    ...
    public static ProblemTaskFragment newInstance() {
        return new ProblemTaskFragment();
    }

    @Override
    protected ProblemTaskPresenterImpl initPresenter() {
        return new ProblemTaskPresenterImpl(this);
    }

    @Override
    protected int getLayoutId() {
        return R.layout.fragment_problem_task;
    }
