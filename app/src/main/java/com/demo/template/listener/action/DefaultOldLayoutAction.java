...
import com.demo.template.ui.grade.common.dialog.LookAnswerDialog;
import com.demo.template.ui.grade.oldx.activity.OldScoreActivity;
import com.demo.template.ui.grade.oldx.adapter.OldScoreAdapter;
 ...
 */
@Deprecated
public class DefaultOldLayoutAction extends DefaultLayoutAction {

    private OldScoreActivity scoreActivity;
    private OldScoreAdapter scoreAdapter;

    public DefaultOldLayoutAction(@NonNull OldScoreActivity scoreActivity, @NonNull OldScoreAdapter scoreAdapter) {
