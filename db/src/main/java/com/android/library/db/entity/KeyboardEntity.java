...
public class KeyboardEntity {
    ...
    @Generated(hash = 1449651469)
    public KeyboardEntity(Long id, @NotNull String markingGroupId,
                          double topicScore, int topicCount, boolean hasLand,
                          boolean hasAutomaticSubmit, boolean hasShowUnAnswerScore,
                          boolean hasDecimal, boolean hasReverse,
